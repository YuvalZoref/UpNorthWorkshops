      ...
      <nav id="navbarHome">
        ...
        <div className='navMenuHome' style={{display: showMenu ? 'flex':'none'}}>
          <div className='navMenuLinksContainerHome'>
            <Link className='navMenuLinkHome' onClick={()=>setShowMenu(false)} to='../About'>About</Link>
            <Link className='navMenuLinkHome' onClick={()=>setShowMenu(false)} to='../Team'>Team</Link>
