    ...
    <footer id="footer">
      <div className='row'>
        ...
        <div className="socialLinksFooter">
          <a href="https://www.facebook.com/people/Up-North-Workshops/61574045660067/" rel="noreferrer" target="blank"><img src={facebookIcon} alt="facebook" className="socialLinkFooter" /></a>
